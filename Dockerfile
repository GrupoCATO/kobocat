...
RUN cd onadata/apps/main && python manage.py makemessages -d djangojs -l es
...
RUN cd onadata/apps/main && python manage.py makemessages -d djangojs -a

RUN python manage.py compilemessages ;
#RUN for app in {main,viewer} ; do cd onadata/apps/${app} && python manage.py compilemessages && cd - ; done
RUN cd onadata/apps/main && python manage.py compilemessages
